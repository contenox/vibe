#!/usr/bin/env bash
# Writes internal/web/beam/beam_ui_embed_stamp.txt with a hash of dist/ contents.
...
DIST="$ROOT/internal/web/beam/dist"
STAMP="$ROOT/internal/web/beam/beam_ui_embed_stamp.txt"
if [ ! -d "$DIST" ]; then
