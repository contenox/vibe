...
// TestUnit_HITLApprovals_AttributionMigratesExistingDatabase verifies a hitl_approvals table predating the attribution columns gains them, with existing rows intact, when the schema is re-applied.
