...
// TestFleetE2E_ComputeBounds_MaxTurnsLandsMissionStuck fires a real ACP subprocess under an envelope with maxTurns=1: the turn budget forbids the nudge and the mission finishes stuck with a reason naming the bound.
