---
title: "Lab"
description: The contenox Lab — research built, shipped, and run for real. Beam web UI, modeld, the HTTP API layer, the UI component library, Bob, runnerd, vald-operator, the early Telegram/GitHub MVP, and blueprints.
---
