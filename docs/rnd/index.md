...
- **[beam: the terminal client](/docs/rnd/beam/)** — the first full-screen terminal client, the finding that a surface must not own policy, and the 2026-08 addendum withdrawing the verdict that followed from it: beam is the first-party client again.
