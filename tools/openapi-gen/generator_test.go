...
func TestGeneratedSpecIsValidAndClientSafe(t *testing.T) {
	...
	assertRequestRef(t, doc, "/plans/compile", "post", "#/components/schemas/planapi_compileRequest")
	assertResponseRef(t, doc, "/plans/compile", "post", "201", "#/components/schemas/planapi_compileResponse")
	assertRequestRef(t, doc, "/plans/active/run-compiled", "post", "#/components/schemas/planapi_runCompiledRequest")
	assertResponseRef(t, doc, "/plans/active/run-compiled", "post", "201", "#/components/schemas/planapi_runCompiledResponse")
